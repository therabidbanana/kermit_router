 ...
 */
class Totaltraffic extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('total_traffic');
	...
	$this->hasColumn('min', 'string', 10, array(
             'type' => 'string',
             'length' => 10,
             'fixed' => false,
             'primary' => false,
	...
	$this->hasColumn('max', 'string', 10, array(
             'type' => 'string',
             'length' => 10,
             'fixed' => false,
             'primary' => false,
	...
	$this->hasColumn('bytes as totalbytes', 'integer', 4, array(
             'type' => 'integer',
             'length' => 8,
             'unsigned' => 0,
             'primary' => false,
